    ...
    <>
      <div className="w-11/12 max-w-[1200px] mx-auto text-white">
        ...
        <section className="mt-28 text-center">
          <header className="text-4xl md:text-5xl font-bold leading-tight">
            Driving Innovation in Online Learning for a{" "}
            <HighlightText text={"Smarter Tomorrow"} />
          </header>
          <p className="mt-6 text-lg text-richblack-300 max-w-[720px] mx-auto">
          ...
          <div className="flex justify-center gap-6 mt-12">
            {[Aboutus1, Aboutus2, Aboutus3].map((img, i) => (
              <img
                ...
                src={img}
                alt={`about-${i}`}
                className="w-[28%] rounded-2xl shadow-lg hover:scale-105 transition-all duration-300"
              />
            ))}
          </div>
        </section>
        ...
        <section className="my-20 w-full">
          <div className="flex flex-col gap-20">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="rounded-2xl bg-richblack-800/60 backdrop-blur-md p-8 shadow-lg hover:shadow-yellow-500/20 transition-all">
